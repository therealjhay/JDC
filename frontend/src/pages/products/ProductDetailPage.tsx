    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="text-center py-32" aria-live="polite">
          ...
          <Link to="/products" className="mt-4 inline-block text-navy-600 hover:underline">← Back to Watches</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <Link to="/products" className="text-navy-600 hover:underline mb-6 inline-block focus-visible:ring-2 focus-visible:ring-navy-400 focus-visible:ring-offset-2 rounded-sm">← Back to Watches</Link>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  ...
                  {allImages.map((img, index) => (
                    <button
                      ...
                      className={`relative flex-shrink-0 h-20 w-20 rounded-lg overflow-hidden border-2 transition-all ${
                        displayImage === img.image_url ? 'border-navy-600' : 'border-transparent'
                      }`}
                    >
                      <img
                        src={img.image_url}
            ...
            <div className="p-8">
              ...
              <div className="text-3xl font-extrabold text-navy-700 mb-6">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg border-2 text-sm font-medium transition-all ${
                          currentVariant?.id === variant.id
                            ...
                            : 'border-gray-200 text-gray-700 hover:border-navy-400'
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center text-lg font-bold hover:border-navy-400 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    −
                  </button>
