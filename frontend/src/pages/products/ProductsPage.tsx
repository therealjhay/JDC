...
export default function ProductsPage() {
  ...
  const [ordering, setOrdering] = useState(() => initialParams.get('ordering') || '');
  ...
  useEffect(() => {
    ...
    setBrand(currentParams.get('brand') || '');
    setCategory(currentParams.get('category') || '');
    setOrdering(currentParams.get('ordering') || '');
  ...
  }, [debouncedSearch, brand, category, ordering, page, navigate, location.search]);
