...
export default function ProductDetailPage() {
  ...
  const handleWhatsAppOrder = () => {
    ...
    const variantDesc = variant
      ? `${variant.color ? variant.color + ' ' : ''}${variant.strap_type || ''}${variant.size ? ', Size: ' + variant.size : ''}`.trim()
      : 'Standard';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <Link href="/products" className="text-yellow-600 hover:underline mb-6 inline-block">← Back to Watches</Link>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.variants.map((variant) => (
                      ...
                      >
                        {variant.color || variant.strap_type || variant.size || variant.sku}
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center text-lg font-bold hover:border-yellow-400 transition-colors"
                  >
                    −
                  </button>
